...
#####  Reste à faire  #####
# TODO: Réglage proxy en automatique
# TODO: format print de la synthesis
# TODO: Modif FDT pour remplacer '-' par '.' ou '_' ds seq name
# TODO: A tester sur Linux puis publier > OK pb avec fonction os.system('pause')
...
# TODO: Revoir l'affichage des couvertures
...
# TODO: Rajout d'une mise en forme auto dans la colonne annotation pour doublon
...
# TODO: Travailler avec les fichiers gb uniquement
...
def main():
    ...
    ##########  Setup  ##########
    path_db = 'R:/BAnAnASpy - DB/RefSeq_Files'  # \\Jacob\PAILLASSES
